...
public final class QueryUtils {
   ...
   private static final String USGS_REQUEST_URL =
    ...
    /**added
     * List<> around Yves both up and down
     * */
    public static ArrayList<Yves> fetchEarthquakeData(String requestUrl) {
        // Create URL object
        ...
        ArrayList<Yves> earthquake = extractFeatureFromJson(jsonResponse);
    ...
    /**
     * Return a list of {@link Yves} objects that has been built up from
     * parsing a JSON response.
     */
    /**
     * original code before addition
    public static ArrayList<Yves> extractYves()
        */

    public static ArrayList<Yves> extractFeatureFromJson(String earthquakeJSON){
        ...
        ArrayList<Yves> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            //creates a JSONObject from the SAMPLE_JSON_RESPONSE string
            //I comment the hardcoded response and added USGS_REQUEST_URL instead of SAMPLE_JSON_RESPONSE


            /**
             * ORIGINAL CODE
             * JSONObject mainObject = new JSONObject(USGS_REQUEST_URL);*/
            ...
            //for loop set i = 0, and if i is still less than the value of the length of
            // earthquakeArray execute the
            //lines of code in teh for loop. After which u add one to the value of i. Indicated by
            //i++
            for (int i = 0; i < earthquakeArray.length(); i++){

                //get the JSONObject at index position i starting at index 0 for the earthquake
                //Array called features
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);

                //get the JSONobject at properties
                JSONObject properties = currentEarthquake.getJSONObject("properties");

                /**OLD extract for magnitude, when it was being extracted as a String
                String magnitude = properties.getString("mag");
                 **/

                // Extract the value for the key called "mag" as a double so as to limit it to
                // one decimal place
                double magnitude = properties.getDouble("mag");


                //extract the vlaue for the key called place
                String location = properties.getString("place");

                /** I changed the format of time from string to long so as to format it to readable
                 *  format
                String time = properties.getString("time");
                 **/
            //extract time in long format
            ...
            //create a new Earthquake object with variable name earthquake
                Yves earthquake = new Yves (magnitude, location, time, url);
